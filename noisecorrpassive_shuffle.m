function  [nn_shuf,nn_bin5fr_shuf,nn_bin10fr_shuf,nn_bin30fr_shuf,rn_shuf,rn_bin5fr_shuf,rn_bin10fr_shuf,rn_bin30fr_shuf,rr_shuf,rr_bin5fr_shuf,rr_bin10fr_shuf,rr_bin30fr_shuf,distnn,distrn,distrr]=noisecorrpassive_shuffle(mouse,date,area,base)
...
for iter=1:1000
    ...
    for i=1:size(deconvnonpass,1)
        ...
        for d=1:2
            for l=1:8
                r=randperm(size(deconvnon_trial{l}{d}{i},1));
                for n=r
...
save([base '\noise_correlations_shuffle\' mouse ' ' date ' ' area 'dfgfdg.mat'],'nn_bin10fr_shuf','rn_bin10fr_shuf','rr_bin10fr_shuf','distnn','distrn','distrr');
